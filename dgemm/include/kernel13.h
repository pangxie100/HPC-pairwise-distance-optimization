...
// %0: ptr_packing_a, %1: ptr_packing_b, %2: ptr_c, %3: LDC_in_bytes, %4: K_inc, %5: M_inc
#define MACRO_KERNEL_n8 {\
  ...
  __asm__ __volatile__(\
    "movq %5,%%r14;"\
    "cmpq $24,%%r14; jb 3243831f;"\
    "3243830:\n\t"\
    COMPUTE_m24n8 "subq $24,%%r14; cmpq $24,%%r14; jnb 3243830b;"\
    "3243831:\n\t"\
    :"+r"(ptr_packing_a),"+r"(ptr_packing_b),"+r"(ptr_c),"+r"(LDC_in_bytes)\
    :"m"(K_inc),"m"(M_inc)\

...
void test_mydgemm_v91(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    mydgemm_cpu_v91(m, n, k, alpha, A, m, B, k, beta, C, m);
}

void test_pzydgemm_v92(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    //mydgemm_cpu_v92(m,n,k,alpha,A,m,B,k,beta,C,m);
    pzydgemm_cpu_v92(m, n, k, alpha, A, m, B, k, beta, C, m);
}

void test_pzydgemm_v10(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    //mydgemm_cpu_v10(m,n,k,alpha,A,m,B,k,beta,C,m);
    pzydgemm_cpu_v10(m, n, k, alpha, A, m, B, k, beta, C, m);
}

void test_mydgemm_v30(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    mydgemm_cpu_v30(m, n, k, alpha, A, m, B, k, beta, C, m);
}

void test_mydgemm_v50(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    mydgemm_cpu_v50(m, n, k, alpha, A, m, B, k, beta, C, m);
}

void test_pzydgemm_v101(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    pzydgemm_cpu_v101(m, n, k, alpha, A, m, B, k, beta, C, m);
}

void test_pzydgemm_v11(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    //mydgemm_cpu_v11(m,n,k,alpha,A,m,B,k,beta,C,m);
    pzydgemm_cpu_v11(m, n, k, alpha, A, m, B, k, beta, C, m);
}

void test_pzydgemm_v111(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    //mydgemm_cpu_v111(m,n,k,alpha,A,m,B,k,beta,C,m);
    pzydgemm_cpu_v111(m, n, k, alpha, A, m, B, k, beta, C, m);
}

void test_pzydgemm_v112(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    //mydgemm_cpu_v112(m,n,k,alpha,A,m,B,k,beta,C,m);
    pzydgemm_cpu_v112(m, n, k, alpha, A, m, B, k, beta, C, m);
}

void test_pzydgemm_v12(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    //mydgemm_cpu_v12(m,n,k,alpha,A,m,B,k,beta,C,m);
    pzydgemm_cpu_v12(m, n, k, alpha, A, m, B, k, beta, C, m);
}

void test_pzydgemm_v120(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    //mydgemm_cpu_v120(m,n,k,alpha,A,m,B,k,beta,C,m);
    pzydgemm_cpu_v120(m, n, k, alpha, A, m, B, k, beta, C, m);
}

void test_pzydgemm_v121(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    //mydgemm_cpu_v121(m,n,k,alpha,A,m,B,k,beta,C,m);
    pzydgemm_cpu_v121(m, n, k, alpha, A, m, B, k, beta, C, m);
}

void test_pzydgemm_v122(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    //mydgemm_cpu_v122(m,n,k,alpha,A,m,B,k,beta,C,m);
    pzydgemm_cpu_v122(m, n, k, alpha, A, m, B, k, beta, C, m);
}

void test_pzydgemm_v130(int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    //mydgemm_cpu_v130(m,n,k,alpha,A,m,B,k,beta,C,m);
    pzydgemm_cpu_v130(m, n, k, alpha, A, m, B, k, beta, C, m);
}
...
void test_kernel(int kernel_num,int m,int n,int k,double alpha,double *A,double *B,double beta,double *C){
    switch (kernel_num){
        ...
        case 91: test_mydgemm_v91(m, n, k, alpha, A, B, beta, C); break;
        case 92: test_pzydgemm_v92(m, n, k, alpha, A, B, beta, C); break;
        case 10: test_pzydgemm_v10(m, n, k, alpha, A, B, beta, C); break;
        case 30: test_mydgemm_v30(m, n, k, alpha, A, B, beta, C); break;
        case 50: test_mydgemm_v50(m, n, k, alpha, A, B, beta, C); break;
        case 101: test_pzydgemm_v101(m, n, k, alpha, A, B, beta, C); break;
        case 11: test_pzydgemm_v11(m, n, k, alpha, A, B, beta, C); break;
        case 111: test_pzydgemm_v111(m, n, k, alpha, A, B, beta, C); break;
        case 112: test_pzydgemm_v112(m, n, k, alpha, A, B, beta, C); break;
        case 12: test_pzydgemm_v12(m, n, k, alpha, A, B, beta, C); break;
        case 120: test_pzydgemm_v120(m, n, k, alpha, A, B, beta, C); break;
        case 121: test_pzydgemm_v121(m, n, k, alpha, A, B, beta, C); break;
        case 122: test_pzydgemm_v122(m, n, k, alpha, A, B, beta, C); break;
        case 130: test_pzydgemm_v130(m, n, k, alpha, A, B, beta, C); break;
        /*
